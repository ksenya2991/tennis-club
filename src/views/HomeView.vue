                ...
                >
                    ...
                    >
                        <div class="coaches-item">
                            ...
                            <div class="coaches-item-title">
                                {{ item.title }}
                            </div>
                            <div class="coaches-item-description">
                                {{ item.description }}
                            </div>
                        </div>
                    </div>
